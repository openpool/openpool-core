...
public class BallDetectorConfigHandler extends ConfigHandlerAbstractImpl {
     ...
     * <dd>None</dd>
     * <dt>1</dt>
     * <dd>Show the entire diff image</dd>
     * <dt>2</dt>
     * <dd>Show the upper half of the diff image</dd>
     * </dl>
     */
    ...
    public void draw() {
        ...
        if (rawMode > 0) {
            synchronized (ballDetector) {
                ...
                if (rawMode == 2) {
                    if (mask == null) {
                        mask = new PImage(diffImage.width, diffImage.height,
                                PImage.GRAY);
                        // mask.loadPixels();
        ...
        op.pa.text("Binarization threshold: " + ballDetector.getThreshold(),
                10, op.getHeight() - 35);
        op.pa.fill(0);
        op.pa.stroke(255);
        ...
        op.pa.fill(255);
        op.pa.noStroke();
        int y = op.pa.g instanceof PGraphicsJava2D ? 28 : 29; // PGraphics bug
                                                                // work around.
        op.pa.rect(12, op.getHeight() - y, (float) ballDetector.getThreshold()
                * (op.getWidth() - 24) / 255, 11);
    ...
    public void mouseEvent(MouseEvent e) {
        ...
        case MouseEvent.MOUSE_DRAGGED:
            if (mousePressed) {
                double threshold = 255.0 * (e.getX() - 12)
                        / (op.getWidth() - 24);
