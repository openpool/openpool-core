...
class ShoalSystem {
    ...
    /**
     * Distance threshold for collision avoidance. (When two shoals come closer
     * than this threshold, force for collision avoidance is applied.)
     */
    static float CA_DISTANCE_THRESHOLD = 100,
     ...
     */
    public Shoal addShoal(float r, float g, float b, int x, int y,
